            ...
            <div class="container-fluid pt-5 d-none d-lg-block">
                <div class="row pt-5">
                    <div class="col-12 text-center">
                        <img src="img/backgrounds/astro_bg_home.png" class="img-fluid" data-aos="fade-zoom-in"
                            data-aos-easing="ease-in-back" data-aos-duration="5000" data-aos-offset="0" />
                    </div>
                    ...
                    <div class="col-12 text-center position-absolute">
                        ...
                        <div class="container">
                            <search-component selectedOpt="startups"></search-component>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row mx-auto text-center">
                    <div class="col-12">
                        <h1>Bienvenido a un Universo<br />de Alto Valor</h1>
                        <h3>
                            <strong>La comunidad que conecta Startups,
                                Profesionales e Inversión</strong>
                        </h3>
                        <h5>
                            Nuestra misión consiste en aportar la conexión para
                    ...
                    <div class="col-12" data-aos="zoom-out" data-aos-duration="3000">
                        ...
                        <div class="row" data-aos="zoom-in" data-aos-duration="1000">
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="home-f-icon text-center">
                                    <img src="img/home/col_1.png" alt="big-bag" class="mx-auto" />
                                </div>
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="home-f-icon text-center">
                                    <img src="img/home/col_2.png" alt="estrellas" class="mx-auto" />
                                </div>
                                <div class="bg-app-blue-1 p-2 h-[9rem]">
                                    <h6 class="font-bold">
                                        Muestra tu estrella
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="home-f-icon text-center">
                                    <img src="img/home/col_3.png" alt="civilizaciones" class="mx-auto" />
                                </div>
                                <div class="bg-app-blue-1 p-2 h-[9rem]">
                                    <h6 class="font-bold">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="home-f-icon text-center">
                                    <img src="img/home/col_4.png" alt="universos" class="mx-auto" />
                                </div>
                                <div class="bg-app-blue-1 p-2 h-[9rem]">
                                    <h6 class="font-bold">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="home-f-icon text-center">
                                    <img src="img/home/col_5.png" alt="ciencia" class="mx-auto" />
                                </div>
                                <div class="bg-app-blue-1 p-2 h-[9rem]">
                                    <h6 class="font-bold">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="home-f-icon text-center">
                                    <img src="img/home/col_6.png" alt="Hipervelocidad" class="mx-auto" />
                                </div>
                                <div class="bg-app-blue-1 p-2 h-[9rem]">
                    ...
                    <div class="col-12">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 benefit-item mb-3 d-flex">
                                ...
                                <div class="benefit-text">
                                    <h3 class="mb-1">
                                        <strong>Conoce otras civilizaciones</strong>
                                    </h3>
                                    <p>
                                        Más emprendedores, profesionales
                                        expertos e inversores quieren conocerte.
                            ...
                            <div class="col-12 benefit-item mb-3 d-flex">
                                ...
                                <div class="benefit-text">
                                    <h3 class="mb-1">
                                        <strong>Explora nuevos universos</strong>
                                    </h3>
                                    <p>
                                        Conoce proyectos que te puedan guiar,
                                        permitan participar o aportar valor.
                            ...
                            <div class="col-12 benefit-item mb-3 d-flex">
                                ...
                                <div class="benefit-text">
                                    <h3 class="mb-0">
                                        <strong>Cuestión de Fe y Ciencia</strong>
                                    </h3>
                                    <p>
                                        Creemos en el poder de la innovación,
                                        investigación, desarrollo y compartir la
            ...
            <div class="container-fluid bg-moon-astro">
                ...
                <div class="row align-items-sm-end align-items-xs-start" style="height: 50%">
                    <div class="col-md-4 col-xs-12 text-center md:mb-20">
                        <a href="{{ route('landings.startup') }}" class="btn btn-outline-primary"
                            style="min-width: 200px">
                            Startup
                        </a>
                    </div>
                    <div class="col-md-4 col-xs-12 text-center">
                        <a href="{{ route('landings.professional') }}" class="btn btn-outline-primary"
                            style="min-width: 200px">
                            Profesional
                        </a>
                    </div>
                    <div class="col-md-4 col-xs-12 text-center md:mb-20">
                        <a href="{{ route('landings.investor') }}" class="btn btn-outline-primary"
                            style="min-width: 200px">
                            Inversor
                        </a>
                    </div>
